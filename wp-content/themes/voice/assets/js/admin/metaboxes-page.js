(function($) {
    ...
    $(document).ready(function() {
        ...
        $('body').on('click', '.vce-add-module', function(e) {
            ...
            var $form = $('#vce-module-clone .' + vce_module_type + ' .vce-module-form').prop('innerHTML');
            var $modal = $('<div class="vce-module-form">' +  $form + '</div>');
        ...
        $('body').on('change', 'select.components-select-control__input', function(e) {
            vce_template_metaboxes( true, this.value );
        });
        ...
        function vce_template_metaboxes(scroll_to, t) {
            ...
            if (template == 'template-authors.php') {
                ...
                $('#vce_layout').fadeOut(300);
                if (scroll_to) {
                    var target = $('#vce_authors').attr('id');
                    $('html, body').stop().animate({
                        'scrollTop': $('#' + target).offset().top
                    }, 900, 'swing', function() {
                        window.location.hash = target;
