	...
	<footer id="footer" class="site-footer">
		...
		<div class="container">
			...
			<?php for ( $i = 0; $i < count( $footer_layout ); $i++ ) : ?>
				<div class="bit-<?php echo esc_attr( $footer_layout[$i] ); ?>">
				...
				<div class="container">
					<?php if($footer_bar_left = vce_get_option('footer_bar_left')): ?>
						<div class="vce-wrap-left">
							<?php get_template_part( 'template-parts/'.$footer_bar_left ); ?>
						</div>
					<?php endif; ?>

					<?php if($footer_bar_right = vce_get_option('footer_bar_right')): ?>
						<div class="vce-wrap-right">
							<?php get_template_part( 'template-parts/'.$footer_bar_right ); ?>
						</div>
					<?php endif; ?>	

					<?php if($footer_bar_center = vce_get_option('footer_bar_center')): ?>
						<div class="vce-wrap-center">
							<?php get_template_part( 'template-parts/'.$footer_bar_center ); ?>
						</div>
					<?php endif; ?>
