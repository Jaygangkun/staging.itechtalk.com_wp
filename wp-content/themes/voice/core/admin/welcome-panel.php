<div id="welcome-panel" class="welcome-panel vce-welcome-panel">
	...
	<div class="welcome-panel-content">
		...
		<h2>Thank you for choosing Voice!</h2>
		...
		<div class="welcome-panel-column-container">
			...
			<div class="welcome-panel-column">
				...
				<a class="button button-primary button-hero" href="<?php echo esc_url(admin_url('themes.php?page=voice-importer')); ?>">Run wizard</a>
			</div>
			...
			<div class="welcome-panel-column welcome-panel-last">
				...
				<a class="button button-primary button-hero" href="https://mekshq.com/documentation/voice/" target="_blank">Read documentation</a>
			</div>
