...
// Don't duplicate me!
if ( ! class_exists( 'ReduxFramework_vce_section' ) ) {
	 ...
	 * @since       1.0.0
	 */
	class ReduxFramework_vce_section {
		...
		public function render() {
			...
			echo '<input type="hidden" id="' . esc_attr($this->field['id']) . '-marker" class="vce-redux-marker"></td></tr></table>';
