...
<?php echo vce_open_column_wrap($mod); ?>
	<div id="main-box-<?php echo esc_attr($k+1); ?>" class="main-box vce-border-top vce-blank-module <?php echo vce_get_column_class($mod); ?> <?php echo esc_attr(vce_get_module_css_class($mod)); ?>">
