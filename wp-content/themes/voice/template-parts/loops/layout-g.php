<article id="post-<?php the_ID(); ?>" <?php post_class('vce-post vce-lay-g'); ?>>
    ...
    <div class="vce-featured-header">
        <div class="vce-featured-info">
            ...
            <?php if($meta = vce_get_meta_data('lay-g')): ?><div class="entry-meta"><?php echo wp_kses_post( $meta ); ?></div><?php endif; ?>
        	
        	<?php if( vce_get_option('lay_g_excerpt')) : ?>
				<div class="entry-content"><p><?php echo vce_get_excerpt('lay-g'); ?></p></div>
			<?php endif; ?>
        </div>
